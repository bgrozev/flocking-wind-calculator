...
val dropzones = listOf(
    ...
    Dropzone("Fallskärmsklubben Aros", 59.577, 16.500),
    Dropzone("HLF Denmark", 56.396, 8.442),
    Dropzone("Jump Georgia Skydiving", 32.650, -81.598),
    Dropzone("Jumptown", 42.568, -72.283),
    Dropzone("Kansas State Skydive", 38.904, -97.236),
    Dropzone("Kolding Faldskærmsklub", 55.437, 9.327),
    Dropzone("Netheravon", 51.245, -1.764),
    Dropzone("Seven Hills Skydivers", 43.258, -89.065),
    Dropzone("Sky Down Skydiving", 43.642, -116.636),
    Dropzone("Skydive Alabama", 34.267, -86.863),
    Dropzone("Skydive Arizona", 32.805, -111.584),
    Dropzone("Skydive Atlanta", 32.953, -84.262),
    Dropzone("Skydive Carolina", 34.791, -81.190),
    Dropzone("Skydive Chelan", 47.866, -119.943),
    Dropzone("Skydive Chicago", 41.400, -88.794),
    Dropzone("Skydive Colorado Springs", 38.427, -105.105),
    Dropzone("Skydive Davis", 38.579, -121.857),
    ...
    Dropzone("Skydive The Ranch", 41.674, -74.151),
    Dropzone("Skydive Utah", 40.619, -112.407),
    Dropzone("Skydive Voss", 60.640, 6.482),
    Dropzone("Skydive West Plains", 47.160, -118.292),
    ...
    Dropzone("Viva Skydive", 34.646, -106.836),
